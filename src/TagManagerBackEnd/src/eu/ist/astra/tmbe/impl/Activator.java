...
public class Activator implements BundleActivator {
	...
	private ITagManagerBackEnd tagManager;
	...
	public void start(BundleContext bc) throws Exception {
		...
		try {
			...
			tagManager = new TagManagerBackEnd(context);
			context.registerService(ITagManagerBackEnd.class.getName(), tagManager, properties);
	...
	public void stop(BundleContext context) throws Exception {
		try {		
			...
			throw new BundleException("Failed to stop Tag Manager Back-End bundle", e);
		}
  	}
}